...
// box data
var menclothingbox = document.querySelector("#clothing-box")
var menclothingbox2 = document.createElement("div")
menclothingbox2.classList.add("clothingbox2")

var menaccbox = document.querySelector("#accesories_box")
var menaccbox2 = document.createElement("div")
menaccbox2.classList.add("accessoriesbox2")
...
//inner card of clothing and accessories div
var minibox = document.createElement("div")
minibox.classList.add("minibox") 

// inner img div of the card
var imagebox = document.createElement("div")
imagebox.classList.add("imagediv")

// img content
var image_content = document.createElement("img")
image_content.classList.add("mainimage")

// card data
var databox = document.createElement("div")
databox.classList.add("dataodcard")

var para1 = document.createElement("p")
para1.classList.add("text1")

var para2 = document.createElement("p")
para2.classList.add("text2")

var para3 = document.createElement("h4")
para3.classList.add("text3")
  
  if(productList[i].isAccessory===false){
        image_content.src=(productList[i].preview)
        imagebox.appendChild(image_content)
        minibox.appendChild(imagebox)
        menclothingbox2.appendChild(minibox)
        menclothingbox.appendChild(menclothingbox2)

        para1.innerText = productList[i].name
        databox.appendChild(para1)
        minibox.appendChild(databox)

        para2.innerText = productList[i].brand
        databox.appendChild(para2)
        minibox.appendChild(databox)
        
        para3.innerText =  ` Rs ${productList[i].price}`
        databox.appendChild(para3)
        minibox.appendChild(databox)
      }
      else{
        image_content.src=(productList[i].preview)
        imagebox.appendChild(image_content)
        minibox.appendChild(imagebox)
        menaccbox2.appendChild(minibox)
        menaccbox.appendChild(menaccbox2)
